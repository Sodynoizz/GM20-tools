...
| `/ประวัติการสั่งจอง` | Order history | ❌ (_Administator_) 
| `/ยกเลิกการจองหนังสือ` | Place number that want to cancle | ❌ (_Administator_) |
| `/รายการสินค้า` | Show product list | ✅ |
| `/รายงานบัค` | Report bot problem | ✅ |
| `/ลบข้อความ` | Clear massages in that channel | ✅ |
| `/ลบประวัติการสั่งจอง` | Clear history | ❌ (_Administator_) |
